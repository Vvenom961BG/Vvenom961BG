...
--Citizen.CreateThread(function() while QBCore == nil do TriggerEvent('QBCore:GetObject', function(obj) QBCore = obj end) Citizen.Wait(10) end end)

local Config = {};
Config.UsesEsx = false --if you use ESX = true
